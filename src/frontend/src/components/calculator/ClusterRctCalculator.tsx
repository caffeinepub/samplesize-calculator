      ...
      <div>
        ...
        <div className="flex items-start gap-2 p-3 mb-4 rounded-lg bg-blue-50 border border-blue-200 text-blue-800">
          ...
          <p className="text-xs leading-relaxed">
            <span className="font-semibold">ICC (ρ):</span> proportion of total
            variance explained by between-cluster differences. Typical values:
            0.01–0.10 for community trials.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          ...
          <div>
            ...
            <Select value={power} onValueChange={setPower}>
              <SelectTrigger data-ocid="cluster.power.select" className="mt-1">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
        ...
        >
          <TabsList className="mb-4 w-full grid grid-cols-2">
            <TabsTrigger value="continuous" data-ocid="cluster.continuous.tab">
              Continuous
            </TabsTrigger>
          ...
          <TabsContent value="continuous" className="space-y-3">
            <div className="grid grid-cols-2 gap-3">
              <div>
                <Label className="text-sm font-semibold">Mean (Control)</Label>
                <Input
